...
A técnica da inversão também pode ser usada para variáveis aleatórias continuas, que são varáveis com suporte em um conjunto não enumerável de valores, como intervalos na reta real, $\mathbb{R}$, ou $(0,\infty)$, por exemplo.
...
Para variáveis contínuas,  o **método da inversão**
consiste em:
...
A seguir, provamos que este método de fato gera uma variável aleatória com a distribuição desejada.
