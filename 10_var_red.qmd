...
ou sejam este estimador tem uma variância menor ou igual à do método de Monte Carlo sem condicionamento.
...
Por construção, $\mathbb{E}[\mathbb{E}[Z_i \mid Y]] = \mathbb{P}(X > 1)$.
 Assim, é natural fazer um estimador Monte Carlo com condicionamento em $X$. Para isso, vamos calcular 
...
$$\frac{1}{n}1 - \Phi\left(\frac{1 - Y_i}{2}\right),$$
